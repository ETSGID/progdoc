...
router.get('/Cumplimentar', (req, res, next) => {
  req.session.menu = [];
...
router.get('/respDoc/tribunales', progDocController.getProgramacionDocente, (req, res, next) => {
  res.locals.rols.push({
  ...
  next();
}, planController.getPlanes, rolController.comprobarRols,
...
router.get('/respDoc/editAsignacion', progDocController.getProgramacionDocente, (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.ResponsableDocente,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: req.session.departamentoID,
...
router.get('/respDoc/editAsignacion/cambioModo', progDocController.getProgramacionDocente, (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.ResponsableDocente,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: req.session.departamentoID,
  ...
  next();
}, planController.getPlanes, progDocController.getProgramacionDocente,
rolController.comprobarRols, asignacionYTribunalController.changeModeAsignacion);

router.post('/respDoc/aprobarAsignacion', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.ResponsableDocente,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: req.session.departamentoID,
...
router.post('/respDoc/guardarAsignacion', progDocController.getProgramacionDocente, (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.ResponsableDocente,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: req.session.departamentoID,
...
router.post('/respDoc/aprobarTribunales', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.ResponsableDocente,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: req.session.departamentoID,
...
asignacionYTribunalController.guardarTribunales, asignacionYTribunalController.aprobarTribunales);

router.post('/respDoc/guardarTribunales', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.ResponsableDocente,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: req.session.departamentoID,
...
asignacionYTribunalController.guardarTribunales, asignacionYTribunalController.reenviar);

router.get('/respDoc/profesores', progDocController.getProgramacionDocente, (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.ResponsableDocente,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: req.session.departamentoID,
...
router.get('/coordinador/horarios', progDocController.getProgramacionDocente, (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.get('/coordinador/examenes', progDocController.getProgramacionDocente, (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
examenController.getFranjas, examenController.getExamenes, examenController.getExamenesView);
...
router.get('/coordinador/franjasexamenes', progDocController.getProgramacionDocente, (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
examenController.getFranjas, examenController.getFranjasView);
...
router.post('/coordinador/guardarHorarios', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
horarioController.guardarHorarios, horarioController.reenviar);
router.post('/coordinador/crearHorariosNota', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordinador/actualizarHorariosNota', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordinador/eliminarHorariosNota', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordinador/guardarExamenes', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
examenController.guardarExamenes, examenController.getExamenes,
examenController.generateCsvExamens, examenController.reenviarExamenes);

router.post('/coordinador/guardarFranjasExamenes', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordiandor/aprobarHorarios', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
horarioController.guardarHorarios, horarioController.aprobarHorarios);

router.post('/coordiandor/aprobarExamenes', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
examenController.guardarExamenes, examenController.aprobarExamenes,
examenController.getExamenes, examenController.generateCsvExamens,
...
router.get('/gestionGrupos/getGrupos', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
rolController.comprobarRols, grupoController.getGrupos);


router.post('/gestionGrupos/guardarGruposJE', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
grupoController.EliminarGruposJE, grupoController.ActualizarGruposJE,
grupoController.AnadirGruposJE);

router.post('/anadirProfesor', personaYProfesorController.anadirProfesor);

router.get('/AbrirCerrar', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
router.post('/abrirProgDoc', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
abrirProgDocController.abrirNuevaProgDoc, abrirProgDoc2Controller.abrirProgDoc);

router.post('/cerrarProgDoc', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
abrirProgDoc2Controller.cerrarProgDoc, calendarioController.anoDeTrabajoPDF,
calendarioController.eventosPlanDiccionario, calendarioController.eventosDiccionario,
calendarioController.getCalendarioPDF, pdfController.generarPDF,
abrirProgDoc2Controller.cerrarProgDoc2);

router.post('/abrirIncidenciaProgDoc', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
abrirProgDocController.abrirCopiaProgDoc, abrirProgDoc2Controller.abrirIncidenciaProgDoc);

router.post('/reabrirProgDoc', (req, res, next) => {
...
abrirProgDocController.abrirCopiaProgDoc, abrirProgDoc2Controller.reabrirProgDoc);

router.post('/cerrarIncidenciaProgDoc', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
abrirProgDoc2Controller.cerrarIncidenciaProgDoc, calendarioController.anoDeTrabajoPDF,
calendarioController.eventosPlanDiccionario, calendarioController.eventosDiccionario,
calendarioController.getCalendarioPDF, pdfController.generarPDF, examenController.getExamenes,
examenController.generateCsvExamens, abrirProgDoc2Controller.cerrarProgDoc2);

// consultarRoles
router.get('/consultar/roles', planController.getPlanes, progDocController.getProgramacionDocente, rolController.getRoles);
// gestionRoles
router.get('/gestionRoles', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
rolController.comprobarRols, rolController.getRoles);
// ruta para guardar

router.post('/gestionRoles/guardarRoles', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
rolController.guardarRoles, rolController.redir);
// atento añadir la ruta del controlador para guardar

router.get('/gestion/acronimos', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
rolController.comprobarRols, acronimoController.getAcronimos);

router.post('/gestionAcronimos/guardarAcronimosJE', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
// gestion de plan
router.get('/gestion/planes', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
rolController.comprobarRols, gestionPlanController.getGestionPlanes);

router.post('/gestion/actualizarPlanApi', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
router.post('/gestion/cambiarEstadoProgDoc', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
router.get('/gestion/calendario', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
calendarioController.anoDeTrabajo, calendarioController.eventosPlanDiccionario,
calendarioController.eventosDiccionario, calendarioController.getCalendario);

router.post('/gestion/calendario/eventoGeneral', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
router.delete('/gestion/calendario/eventoGeneral', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
router.post('/gestion/calendario/aprobarGeneral', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
router.post('/gestion/calendario/copiarEventos', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
router.get('/cumplimentar/calendario', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
rolController.comprobarRols, calendarioController.anoDeTrabajo,
calendarioController.eventosPlanDiccionario,
calendarioController.eventosDiccionario, calendarioController.getCalendarioPlan);

router.delete('/cumplimentar/calendario/eventoGeneral', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
rolController.comprobarRols, calendarioController.deleteEventoPlan);

router.post('/cumplimentar/calendario/eventoGeneral', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
rolController.comprobarRols, calendarioController.postEventoPlan);
...
router.post('/cumplimentar/calendario/eventoEditablePlan', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
rolController.comprobarRols, calendarioController.editablePlan);

// -----Aulas-----//
router.get('/gestion/aulas', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
router.post('/gestion/aulas/generarPdf', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.JefeEstudios,
    PlanEstudioCodigo: null,
    DepartamentoCodigo: null,
...
router.get('/cumplimentar/actividades', planController.getPlanes, progDocController.getProgramacionDocente, (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordiandor/aprobarActividades', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordinador/crearActividad', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordinador/actualizarActividad', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordinador/eliminarActividad', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordiandor/crearConjuntoActividadParcial', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordiandor/actualizarConjuntoActividadParcial', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
...
router.post('/coordiandor/eliminarConjuntoActividadParcial', (req, res, next) => {
  res.locals.rols.push({
    rol: enumsPD.rols.CoordinadorTitulacion,
    PlanEstudioCodigo: req.session.planID,
    DepartamentoCodigo: null,
